...
COMMAND="jps -lm | grep -i detail-schema-part-1.xml"
...
then
      ...
      /home/xdrloader/projects/moveToParquet/load-to-hive-parq-assembly-1.0.jar hdfs:///spark-scripts-config/load-to-hive/detail-schema-part-1.xml convert-to-parquet-DETAIL-1
      " 
      eval $sparkRun
fi
