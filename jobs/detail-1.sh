...
then
      ...
      /opt/client/Spark/scripts/moveToParquet/load-to-hive-parq-assembly-1.0.jar hdfs:///spark-scripts-config/load-to-hive/detail-schema-part-1.xml convert-detail-1
      " 
      eval $sparkRun
fi
