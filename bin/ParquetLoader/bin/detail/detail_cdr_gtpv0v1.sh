...
COMMAND="jps -lm | grep -i DETAIL_CDR_GTPV0V1.json"
...
then
      ...
      --name conv-to-parq[detail_cdr_gtpv0v1]
      --master yarn 
      --deploy-mode cluster 
      ...
      --files '$HOME/configs/DETAIL_CDR_GTPV0V1.json'
      $HOME/lib/parquetLoader.jar DETAIL_CDR_GTPV0V1.json
      " 
      eval $sparkRun
fi
