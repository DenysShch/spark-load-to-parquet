...
COMMAND="jps -lm | grep -i DETAIL_CDR_S1Release.json"
...
then
      ...
      --name conv-to-parq[detail_cdr_s1release]
      --master yarn
      ...
      --files '$HOME/configs/DETAIL_CDR_S1Release.json'
      $HOME/lib/parquetLoader.jar DETAIL_CDR_S1Release.json
      "
      eval $sparkRun
fi
