...
COMMAND="jps -lm | grep -i DETAIL_UFDR_MMS.json"
...
then
      ...
      --name conv-to-parq[detail_ufdr_mms]
      --master yarn
      ...
      --files '$HOME/configs/DETAIL_UFDR_MMS.json'
      $HOME/lib/parquetLoader.jar DETAIL_UFDR_MMS.json
      "
      eval $sparkRun
fi
