...
COMMAND="jps -lm | grep -i DETAIL_CDR_S1OTHER.json"
...
then
      ...
      --name conv-to-parq[detail_cdr_s1other]
      --master yarn
      --deploy-mode cluster
      ...
      --files '$HOME/configs/DETAIL_CDR_S1OTHER.json'
      $HOME/lib/parquetLoader.jar DETAIL_CDR_S1OTHER.json
      "
      eval $sparkRun
fi
