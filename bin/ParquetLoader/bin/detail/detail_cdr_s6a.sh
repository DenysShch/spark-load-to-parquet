...
COMMAND="jps -lm | grep -i DETAIL_CDR_S6a.json"
...
then
      ...
      --name conv-to-parq[detail_cdr_s6a]
      --master yarn
      --deploy-mode cluster
      ...
      --files '$HOME/configs/DETAIL_CDR_S6a.json'
      $HOME/lib/parquetLoader.jar DETAIL_CDR_S6a.json
      "
      eval $sparkRun
fi
