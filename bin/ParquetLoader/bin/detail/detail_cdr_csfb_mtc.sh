...
COMMAND="jps -lm | grep -i DETAIL_CDR_CSFB_MTC.json"
...
then
      ...
      --name conv-to-parq[detail_cdr_csfb_mtc]
      --master yarn
      ...
      --files '$HOME/configs/DETAIL_CDR_CSFB_MTC.json'
      $HOME/lib/parquetLoader.jar DETAIL_CDR_CSFB_MTC.json
      "
      eval $sparkRun
fi
