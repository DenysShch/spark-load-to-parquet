...
COMMAND="jps -lm | grep -i TDR_H248_DTMF.json"
...
then
      ...
      --name conv-to-parq[tdr_h248_dtmf]
      --master yarn
      --deploy-mode cluster
      ...
      --files '$HOME/configs/TDR_H248_DTMF.json'
      $HOME/lib/parquetLoader.jar TDR_H248_DTMF.json
      "
      eval $sparkRun
fi
