...
COMMAND="jps -lm | grep -i TDR_AIU_MTSMS.json"
...
then
      ...
      --name conv-to-parq[tdr_aiu_mtsms]
      --master yarn
      ...
      --files '$HOME/configs/TDR_AIU_MTSMS.json'
      $HOME/lib/parquetLoader.jar TDR_AIU_MTSMS.json
      "
      eval $sparkRun
fi
