...
COMMAND="jps -lm | grep -i TDR_H248_TERM.json"
...
then
      ...
      --name conv-to-parq[tdr_h248_term]
      --master yarn
      --deploy-mode cluster
      ...
      --files '$HOME/configs/TDR_H248_TERM.json'
      $HOME/lib/parquetLoader.jar TDR_H248_TERM.json
      "
      eval $sparkRun
fi
